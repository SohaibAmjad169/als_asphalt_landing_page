...
const Lettalk = ({openModal}: LettalkProps) => {
  return (
        ...
        >
          ...
          <div className="flex flex-col items-start gap-[40px] w-[100%] md:w-[50%]">
            <div className="flex flex-col items-start gap-4">
              ...
              Whether you’re planning ahead or need a quick repair, we’re here to help. Call us or request a quote today - no pushy sales, just solid advice. 
              </p>
            </div>
            <Link 
                onClick={openModal}
