...
const OurStory = () => {
  return (
    <section className="relative bg-black py-30 md:py-24 lg:py-30 overflow-hidden rounded-b-2xl about-border-sec">
      ...
      <div className="absolute left-1/2 top-[-1px] transform -translate-x-1/2 z-10" style={{ width: '112px', height: '57px' }}>
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M56 56.837C56 25.9091 30.9279 0.837036 0 0.837036H112C81.0721 0.837036 56 25.9091 56 56.837Z" fill="#FAFAFA"/>
        </svg>
      </div>
      ...
      <div className="absolute bottom-arrow left-1/2 transform -translate-x-1/2 z-10" style={{ width: '112px', height: '56px' }}>
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M56 0.738892C56 31.6668 30.9279 56.7389 0 56.7389H112C81.0721 56.7389 56 31.6668 56 0.738892Z" fill="#FAFAFA"/>
        </svg>
      </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-[133px]">
          <div className="flex-1 flex flex-col gap-3 mb-12 lg:mb-0 relative z-[2]">
            <div className="flex items-center gap-3 mb-3 justify-center md:justify-start">
              ...
              <p className="text-white font-medium leading-relaxed why_txt">Member of the community</p>
            </div>
            ...
            <p className="text-white/83 text-center md:text-left leading-relaxed mb-0 md:mb-2 ab_para">
            Al’s Asphalt was founded by Allen McElroy with one goal in mind: bring real professionalism to the pavement game. After years of seeing corner-cutting and rushed jobs, Allen decided it was time to raise the standard in mid-Michigan.             </p>
            <i>
            <p className="text-white/83 text-center md:text-left leading-relaxed mb-0 ab_para">            
            “I don’t just want to get it done. I want it done right - so it lasts.” 
             </p>
             </i>
             <p className="text-white/83 text-center md:text-left leading-relaxed allen_txt">            
             - Allen McElroy, Owner
             </p>            
          </div>
