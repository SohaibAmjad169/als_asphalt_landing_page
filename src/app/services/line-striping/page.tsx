...
import LotOrganization from '@/components/services/lineStriping/lotOrgnization';
import LcrServices from '@/components/services/lineStriping/LineService';
...
export default function CrackRepair() {
  ...
  return (
    <main className="overflow-x-hidden w-full" >
          ...
          <div className="flex flex-col align-middle justify-center mb-0 md:mb-8 pt-5 pb-[32px] md:py-5 mt-5 md:mt-10">
            ...
            <div className="md:w-[67.5%] self-center hero-btn text-center">
              <p className="text-[rgba(0,0,0,0.8)] mb-6 leading-relaxed font-inter text-center">
                Faded or poorly marked lines lead to confusion, customer
                complaints, and even code violations. We deliver sharp, durable
                striping that keeps your lot organized, safe, and compliant.
              </p>
      ...
      <LcrServices openModal={openModal}/>
