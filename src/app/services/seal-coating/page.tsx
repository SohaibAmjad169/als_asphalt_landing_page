...
import SurfaceProtection from '@/components/services/sealCoating/surfaceProtection';
import ScrServices from '@/components/services/sealCoating/ScServices';
...
export default function CrackRepair() {
  ...
  return (
    <main className="overflow-x-hidden w-full">
          ...
          <div className="flex flex-col align-middle justify-center mb-0 md:mb-8 pt-5 pb-[32px] md:py-5 mt-5 md:mt-10">
            ...
            <div className="md:w-[67.5%] self-center hero-btn text-center">
              <p className="text-[rgba(0,0,0,0.8)] mb-6 leading-relaxed font-inter text-center">
                Seal coating creates a deep black finish while defending your
                pavement from UV rays, oil stains, moisture, and everyday
                damage.
              </p>
      ...
      <ScrServices openModal={openModal}/>
