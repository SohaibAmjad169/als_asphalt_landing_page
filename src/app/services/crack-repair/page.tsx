...
import CrackProtection from '@/components/services/crackRepair/CrackProtection';
...
import RcrServices from '@/components/services/crackRepair/RcrServices';
...
export default function CrackRepair() {
  ...
  return (
    <main className="overflow-x-hidden w-full">
      ...
      <div className="container mx-auto px-4 py-5 bg-[rgba(5, 5, 5, 0.03)]">
          ...
          <div className="flex flex-col align-middle justify-center mb-0 md:mb-8 pt-5 pb-[32px] md:py-5 mt-5 md:mt-10">
            ...
            <div className="md:w-[67.5%] self-center hero-btn text-center">
              <p className="text-[rgba(0,0,0,0.8)] mb-6 leading-relaxed font-inter text-center">
                Small cracks can quickly become big problems. Our crack repair
                service seals them up tight, keeping moisture out and preventing
                further damage to your asphalt surface.
              </p>
      ...
      <RcrServices openModal={openModal}/>
