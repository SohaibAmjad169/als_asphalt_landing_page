...
const LocationSection = ({openModal}: LocationSectionProps) => {
    const [activeItem, setActiveItem] = useState<string>("Extends Surface Life");
                    ...
                    <div className="w-full md:w-[65%] flex flex-col">
                        <h2 className="font-comfortaa font-bold leading-tight mb-0 text-black flex flex-wrap items-center hidden md:flex">
                            ...
                            <div className='flex items-center'>
                                ...
                                <span>Pothole Repair Services</span>
                            </div>
                        </h2>
                    ...
                    <div className="w-full md:w-[45%] mt-[-30px] md:mt-[0px]">
                        <div className="space-y-0">
                            <IndustryItem
                                ...
                                isActive={activeItem === "Extends Surface Life"}
                                onClick={() => toggleItem("Extends Surface Life")}
                                description="Properly filled potholes prevent deeper base damage, saving you from expensive repaving."
                            />

                            <div className="border-t border-[rgba(13,36,64,0.16)] pt-4 mt-4">
                                <IndustryItem
                                    title="Improves Safety & Reduces Liability"
                                    isActive={activeItem === "Improves Safety & Reduces Liability"}
                                    onClick={() => toggleItem("Improves Safety & Reduces Liability")}
                            ...
                            <div className="border-t border-[rgba(13,36,64,0.16)] pt-4 mt-4">
                                <IndustryItem
                                    ...
                                    isActive={activeItem === "Works on All Surfaces"}
                                    onClick={() => toggleItem("Works on All Surfaces")}
...
const PcrServices = ({openModal}: ScrServicesProps) => {
    return (
        <>
