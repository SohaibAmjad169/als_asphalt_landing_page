...
const ServiceCard = ({
    ...
    return (
        <div
            className={`w-full ${width} ${height} rounded-[24px] p-[24px] flex flex-col items-center justify-center text-center gap-[20px] relative overflow-hidden transition-colors duration-300 bg-[rgba(5,5,5,0.02)] border border-black/10 serving-card`}
        >
            {/* Icon */}
