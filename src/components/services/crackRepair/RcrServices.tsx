...
const LocationSection = ({openModal}: LocationSectionProps) => {
    const [activeItem, setActiveItem] = useState < string > ("Protects against water damage");

    const toggleItem = (item: SetStateAction<string>) => {
                ...
                <div className="flex flex-col md:flex-row gap-16 items-start">
                    ...
                    <div className="w-full md:w-[65%] flex flex-col">
                        <h2 className="font-comfortaa font-bold leading-tight mb-0 text-black flex flex-wrap items-center hidden md:flex">
                            ...
                            <div className='flex items-center'>
                                ...
                                <span>Crack Repair Services</span>
                            </div>
                        </h2>
                        ...
                        Ignoring small cracks can lead to major damage - and expensive repairs down the line. Our professional crack repair service stops the problem at the source, saving you time, money, and headaches.
                        </p>
                    ...
                    <div className="w-full md:w-[45%] mt-[-30px] md:mt-[0px]">
                        <div className="space-y-0">
                            <IndustryItem
                                title="Protects against water damage"
                                isActive={activeItem === "Protects against water damage"}
                                onClick={() => toggleItem("Protects against water damage")}
                                description="Sealing cracks blocks moisture from seeping in and causing further weakening to find tailored."
                            />

                            <div className="border-t border-[rgba(13,36,64,0.16)] pt-4 mt-4">
                                <IndustryItem
                                    title="Extends the life of your asphalt"
                                    isActive={activeItem === "Extends the life of your asphalt"}
                                    onClick={() => toggleItem("Extends the life of your asphalt")}
                            ...
                            <div className="border-t border-[rgba(13,36,64,0.16)] pt-4 mt-4">
                                <IndustryItem
                                    title="Driveways, parking lots, & roads"
                                    isActive={activeItem === "Driveways, parking lots, & roads"}
                                    onClick={() => toggleItem("Driveways, parking lots, & roads")}
...
const RcrServices = ({openModal}: ScrServicesProps) => {
    return (
        <>
