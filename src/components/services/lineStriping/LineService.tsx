...
const IndustryItem = ({
  ...
  return (
    <div className="w-full">
      ...
      >
        <div
          className="text-black/80 pl-0 pb-2 text-base leading-relaxed group-des"
          style={{
            fontFamily: 'Inter',
            lineHeight: '1.7em',
          ...
          <div className="w-full md:w-[65%] flex flex-col">
            <h2 className="font-comfortaa font-bold leading-tight mb-0 text-black flex flex-wrap items-center hidden md:flex">
              ...
              <span className="inline-flex items-center mx-1">
                <div className="rounded-full bg-primary flex items-center justify-center mx-1 w-[45px] lg:w-[59px] h-[45px] lg:h-[59px]">
                  <Image
              ...
              <div className="flex items-center">
                <span className="inline-flex items-center me-1">
                  <div className="rounded-full bg-primary flex items-center justify-center me-1 w-[45px] lg:w-[59px] h-[45px] lg:h-[59px]">
                    <Image
                      src="/images/line_stripe.png"
                      alt="Line Stripe Icon"
                      width={59}
                      height={59}
                      quality={100}
                      priority={true}
                ...
                <span>Line Striping Services</span>
              </div>
            </h2>
            ...
            <h2 className="font-comfortaa font-bold leading-tight mb-0 text-black flex flex-wrap items-center md:hidden">
              ...
              <div className="rounded-full flex items-center justify-center mx-1"></div>
              <span
                style={{
                  fontWeight: 900,
                  lineHeight: 1.5,
              ...
              >
                Standish, Pinconning, Omer, Au Gres, <br />
                and Saginaw.
              </span>
            </h2>

            <p
              className="text-black/80 md:w-[85%] mt-5 pl-0 pb-2 text-base leading-relaxed group-des"
              style={{
                fontFamily: 'Inter',
                lineHeight: '1.7em',
                color: 'rgba(0, 0, 0, 0.83)',
            ...
            >
              Professional striping improves safety, flow, and first
              impressions. Whether it&apos;s a small lot or a large commercial
              complex, we lay it out clean, compliant, and fast.
            </p>
          ...
          <div className="w-full md:w-[45%] mt-[-30px] md:mt-[0px]">
            <div className="space-y-0">
              <IndustryItem
                ...
                isActive={activeItem === 'Minimizes Business Disruption'}
                onClick={() => toggleItem('Minimizes Business Disruption')}
                description="We offer flexible scheduling - including evenings and weekends to ensure your business operations are never disrupted."
              />

              <div className="border-t border-[rgba(13,36,64,0.16)] pt-4 mt-4">
                <IndustryItem
                  title="Boosts Property Appearance"
                  isActive={activeItem === 'Boosts Property Appearance'}
                  onClick={() => toggleItem('Boosts Property Appearance')}
              ...
              <div className="border-t border-[rgba(13,36,64,0.16)] pt-4 mt-4">
                <IndustryItem
                  title="Ensures ADA Compliance"
                  isActive={activeItem === 'Ensures ADA Compliance'}
                  onClick={() => toggleItem('Ensures ADA Compliance')}
...
const LcrServices = ({openModal}: ScrServicesProps) => {
  return (
    <>
