    ...
    return (
        <section className="relative bg-black py-30 md:py-24 lg:py-30 overflow-hidden rounded-b-2xl about-border-sec">
            ...
            <div className="container mx-auto relative z-[1]">
                <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:gap-[133px]">
                    <div className="flex-1 relative z-[2]">
                        <div className="rounded-2xl overflow-hidden h-[auto] md:h-[427px]">
                            <Image
                                src="/images/lot_orgn.png"
                    ...
                    <div className="flex-1 flex flex-col gap-3 mb-12 lg:mb-0 relative z-[2]">
                        <div className="flex items-center gap-3 mb-3 justify-center md:justify-start lg:pt-0">
                            <div style={{ width: '10px', height: '10px', backgroundColor: '#FFEB38', borderRadius: '50%' }}></div>
                            <p className="text-white font-medium leading-relaxed why_txt">Lot Organization </p>
                        </div>

                        <h2 className="text-white font-comfortaa font-semibold mb-5 text-center md:text-start">
                            Visibility That Guides.<br />Compliance That Protects.
                        </h2>

                        <p className="text-white/83 text-center md:text-left leading-relaxed w-[98%] md:max-w-[500px] mb-0 md:mb-2 ab_para">
                        Clear striping isn’t just about looks - it’s about efficiency, safety, and staying up to code.  We use fast-drying, high-contrast paint and precise application tools to mark your lot with clean lines and professional layouts that last.
                        </p>
                            <i>
                                <p className="text-white/83 text-center md:text-left leading-relaxed w-[98%] md:max-w-[500px] mb-0 md:mb-8 ab_para">
                                From re-striping faded lots to designing new layouts, we help your business stay sharp and accessible.
                                </p>
                            </i>
                    </div>
                </div>
...
export default LotOrganization; 